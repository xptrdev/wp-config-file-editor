...
<?php do_action( 'admin_print_styles' ); ?>
	...
	<body>
		<div id="wcfe-profile-edit" class="wcfe-popup-view">
			<form action="<?php echo $router->route( new \WPPFW\MVC\MVCViewParams( 'Editor', 'Profiles', 'Edit', '', 'Profile' ) ) ?>&caller=<?php echo $result[ 'caller' ] ?>&storageId=<?php echo $result[ 'storageId' ] ?>" method="post">
				<fieldset>
					<ul>
						<li>
