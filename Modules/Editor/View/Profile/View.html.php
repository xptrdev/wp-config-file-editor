...
namespace WCFE\Modules\Editor\View\Profile;
...
extends TemplateView
{
	...
	*/
	protected function initialize() {
		...
		$this->scriptsQueue->add( $this->resFactory->getRes( 'WCFE\Modules\Editor\View\Profile\Media\Profile' ), true );
		
		# Styles
		
		$this->stylesQueue->add( $this->resFactory->getRes( 'WCFE\Modules\Editor\View\Profile\Media\EditCSS' ) );
