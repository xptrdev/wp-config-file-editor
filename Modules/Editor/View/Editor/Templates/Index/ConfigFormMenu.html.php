...
<ul id="wcfe-config-form-main-menu">
    <li>
        ...
        <ul>
            ...
            <li id="wcfe-dmm-info-paths" title="<?php $this->_e( 'Discover your installation path information' ) ?>"><?php $this->_e( 'Path Info' ) ?></li>
            ...
            <li id="wcfe-dmm-secure-keys-generate"><?php $this->_e( 'Generate Secure Key' ) ?></li>
            <li id="wcfe-dmm-secure-keys-generate-all"><?php $this->_e( 'Generate All Secure Keys' ) ?></li>
